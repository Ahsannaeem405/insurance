            ...
            <div>
                ...
                @foreach($rec->conditionQuestions as $question)
                    ...
                    @if($question->type_id==1)
                        ...
                        <div class="current_ques_{{$i}} all_ques" jump="1" @if($i>=2) style="display: none" @endif>
                    ...
                    @elseif($question->type_id==2)
                        <div class="current_ques_{{$i}} all_ques parent" jump="1" answer="yes" ifyes="{{$question->if_yes}}" i="{{$i}}" ifno="{{$question->if_no}}" @if($i>=2) style="display: none" @endif>
                            <h3 class="text-center mt-2">{{$question->question}}</h3>
                            <div class="container">
                                <div class="row m-0 mt-3">
                                    <div class="col-6 " style="margin: auto;cursor: pointer">
                                        <p class="p-2 selection selection{{$question->id}}"
                                           next_ques="{{$question->if_yes}}" data_id="{{$question->id}}" i="{{$i}}" data="yes"
                                           style="border: 1px solid #22339e;border-radius: 10px;color: white;background-color:#22339e ; text-align: center">
                                            Yes</p>
                                    </div>

                                    <div class="col-6 " style="margin: auto;cursor: pointer">
                                        <p class="p-2 selection selection{{$question->id}}" data="no" i="{{$i}}"
                                           next_ques="{{$question->if_no}}" data_id="{{$question->id}}"
...
{{--first condition--}}
                        ...
                        @if($question->if_yes!=0)
                            @php
                                $next_ques=\App\Models\conditionQuestion::where('question_id',$question->if_yes)->first();
                            ++$i;
                            @endphp
                            ...
                            @if($next_ques->type_id==1)

                                <div class="current_ques_{{$i}} all_ques child" jump="1" @if($i>=2) style="display: none" @endif>
                                    <h3 class="text-center mt-2">{{$next_ques->question}}</h3>
                                    <div class="container">
                                        <div class="row m-0 mt-3 ">
                                            <div class="col-lg-8 d-flex m-auto">
                                                <div class="col-4">
                            ...
                            @elseif($next_ques->type_id==2)
                                ...
                                <div class="current_ques_{{$i}} all_ques child" jump="1" @if($i>=2) style="display: none" @endif>
                                    ...
                                    <div class="container">
                                        <div class="row m-0 mt-3">
                                            <div class="col-6 " style="margin: auto;cursor: pointer">
                                                <p class="p-2 selection selection{{$next_ques->id}}"
                                                   next_ques="0" data_id="{{$next_ques->id}}"
                                                   data="yes"
                                                   style="border: 1px solid #22339e;border-radius: 10px;color: white;background-color:#22339e ; text-align: center">
                                                    Yes</p>
                                            </div>
                                            ...
                                            <div class="col-6 " style="margin: auto;cursor: pointer">
                                                <p class="p-2 selection selection{{$next_ques->id}}" data="no"
                                                   next_ques="0" data_id="{{$next_ques->id}}"
                                                   style="border: 1px solid #22339e;border-radius: 10px;color: black;text-align:center">
                                                    No</p>
                                            </div>
...
{{--   second condition                 --}}
                        ...
                        @if($question->if_no!=0)
                            @php
                                $next_ques=\App\Models\conditionQuestion::where('question_id',$question->if_no)->first();
                            ++$i;
                            @endphp
