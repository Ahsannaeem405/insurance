        ...
        @if($rec->conditionQuestions!=null)
            ...
            @foreach($rec->conditionQuestions as $question)
                    ...
                    @if($question->type_id==1)
                        ...
                        <div class="current_ques_{{$i}} all_ques" @if($i>=2) style="display: none" @endif>
            ...
            @endforeach
                <div class="row mt-5 text-center">
                    <div class="m-auto">
                        ...
                        <input type="button" id="back_ques" class="btn btn-secondary back_ques{{$rand}}" current="1" rand="{{$rand}}" total="{{count($rec->conditionQuestions)}}" value="BACK" >
                        <span class="start_status{{$rand}}">1</span> / <span class="end_status{{$rand}}">{{count($rec->conditionQuestions)}}</span>
                        <input type="button" value="NEXT" class="next_ques{{$rand}} btn btn-primary" id="next_ques" current="1" rand="{{$rand}}" total="{{count($rec->conditionQuestions)}}" style="background-color: #8b8be1;border: #8282cb" >
                    </div>
                </div>
