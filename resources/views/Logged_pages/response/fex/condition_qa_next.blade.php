    ...
    <div class="container">
        <div class="row m-0 mt-3">
            <div class="col-6 " style="margin: auto;cursor: pointer">
                <p class="p-2 selection selection_{{$rand}}_{{$question->id}}" next_ques="{{$question->if_yes}}" rand="{{$rand}}" data_id="{{$question->id}}" i="{{$i}}" data="yes" style="border: 1px solid #22339e;border-radius: 10px;color: white;background-color:#22339e ; text-align: center">
                    Yes</p>
            </div>
            <div class="col-6 " style="margin: auto;cursor: pointer">
                <p class="p-2 selection selection_{{$rand}}_{{$question->id}}" data="no" i="{{$i}}" next_ques="{{$question->if_no}}" rand="{{$rand}}" data_id="{{$question->id}}" style="border: 1px solid #22339e;border-radius: 10px;color: black;text-align:center">
                    No</p>
            </div>
        </div>
    </div>
