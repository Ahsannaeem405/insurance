...
@section('title')
<title>Legeal Checker Term</title>
@endsection
<style>
    .table {
        margin-top: 80px;
...
<div class="container-fluid" style="min-height: 500px;padding-bottom:100px;">
    @include('Logged_pages.legalChecker.layout.layout')
    <!-- Tab panes -->
                        ...
                        <div class="row" style="margin-top: 40px;">
                            <div class="col-lg-12 col-12">
                                ...
                                <div class="row" style="justify-content: space-between;">
                                    <div class="col-lg-6">
                                        <label for="">Select Offense</label>
                                        <select name="" id="offense" class="form-control input-background">
                                            <option value="">Please select</option>
                                            @foreach($offends as $offend)
                                                <option value="{{$offend->offense_id}}">  {{$offend->offense_e}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-lg-12 col-12">
                                ...
                                <div class="row" style="margin-top: 40px;">
                                    ...
                                    <div class="col-lg-4" style="">
                                        <label for="" style="margin:0">{{'Select Year'}}</label>
                                        <select name="type" class="form-control input-background">

                                            <option selected value="tens">10</option>
                                            <option value="fifteens">15</option>
                                            <option value="twenties">20</option>
                                            <option value="twentyfives">25</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-12" style="text-align: center;margin-top:72px">
                                        <button id="get_quote_lterm" type="button" style="" class="btn btn-dark quote">{{__('profile.Get Quote')}}</button>
                                        <br><br>
                                    </div>
                                </div>
                            </div>
...
<script src="{{asset('assets/js/legealterm.js')}}"></script>
