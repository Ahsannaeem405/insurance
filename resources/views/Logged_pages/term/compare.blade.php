...
<div class="container-fluid" style="min-height: 500px;padding-bottom:100px;">
    @include('Logged_pages.term.layout.layout')
                            ...
                            <div class="row" style="margin-top: 40px;">
                                ...
                                <div class="col-lg-5 ml-lg-5" style="margin-top: 20px;display: block">
                                    ...
                                    <select name="type" class="form-control input-background">
                                        <option @if($request->type=='tens')selected @endif value="tens">10</option>
                                        <option @if($request->type=='fifteens')selected @endif value="fifteens">15</option>
                                        <option @if($request->type=='twenties')selected @endif value="twenties">20</option>
                                        <option @if($request->type=='twentyfives')selected @endif value="twentyfives">25</option>
                                        <option @if($request->type=='thirties')selected @endif value="thirties">30</option>
                                    </select>
                                </div>
                        ...
                        <div class="container-fluid">
                            <div class="row ml-1">
                                ...
                                <div class="col-lg-4 col-12 " style="text-align: center;">
                                    <button id="get_quote_compare_term" type="button" style="background-color:#6B5EFF;margin-top: 32px;width: 182px; margin-left: 140px;border:none" class="btn btn-dark">{{__('profile.Get Quote')}}</button>
                                    <br><br>
                                </div>
                            </div>
                        </div>
...
<script src="{{asset('assets/js/termcustom.js')}}"></script>
