...
<div class="container-fluid con_fluid">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-12" style="padding: 150px 80px 20px 80px;">
            <h1 style="color: #340856"><i class="fas fa-clinic-medical"></i> Quotes</h1><br>
            <p style="color: #340856">An underwriting, quoting, CRM, and sales software tool suite designed for Medicare Supplement insurance agents.</p> <br>
