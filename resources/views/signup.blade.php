    ...
    <div class="col-lg-12 " style="margin-top:20px">
        <div class="container box_orange">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5 col-6" style="text-align: center;    display: flex;">
                    <div class="box">
                ...
                <div class="col-lg-12 col-12" style="padding-top:20px; ">
                    <ul>
                        ...
                        <li>Access to CRM</li>
                        <li>Unlimited quotes per day on your shareable ‘Lite Link’. Every account comes with your own public URL that you can share with a colleague or bookmark on your phone.</li>
                    </ul>
                </div>
            </div>
...
/month</b>
                ...
                <div class="col-lg-12 col-12" style="padding-top:20px; ">
                    <center style="color: gray; padding-bottom:20px;">All the features of the Business Plan, plus..</center>
                    <ul>
                        <li>Create and remove agent accounts</li>
                        <li>Includes 5 agent accounts. More accounts can be added at $24.99/account per month.</li>
                        <li>Unlimited use of all in-field sales tools</li>
