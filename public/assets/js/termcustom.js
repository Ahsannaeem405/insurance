$(document).ready(function () {
    ...
    $("#get_quote_term").click(function () {
        ...
        if (check == true) {
            ...
            $.ajax({
                type: 'POST',
                url: "" + baseurl + "/user/get_quote_term",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
...
var response=true;
    ...
    $("#get_quote_compare_term").click(function () {
        ...
        if (check == true) {
            ...
            $.ajax({
                type: 'POST',
                url: "" + baseurl + "/user/get_quote_compare_term",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function (response) {
                    $('#get_quote_compare_term').prop('disabled', false);
                    $('.result').empty().append(response);
                }
            });
        }
