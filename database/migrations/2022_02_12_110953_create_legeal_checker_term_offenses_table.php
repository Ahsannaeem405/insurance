...
class CreateLegealCheckerTermOffensesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('legeal_checker_term_offenses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('legeal_checker_term_offenses');
    }
}
